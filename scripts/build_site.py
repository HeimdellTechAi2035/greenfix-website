...
AREA_SERVED = ["Preston", "Lancashire", "Wigan", "Greater Manchester",
               "Penwortham", "Leyland", "Chorley", "Fulwood", "Bamber Bridge"]
FOUNDED = "2015"
JOBS_COUNT = "500+"
...
CLUSTERS = [
    ...
    },
    {
        ...
        "slugs": ["exterior-structural-repairs", "repairs-and-maintenance",
                  ...
                  "fence-repairs", "gate-repairs", "patio-repairs",
...
SERVICES = [
    ...
    dict(
        ...
        h1="Grounds Maintenance in Preston & Lancashire",
        ...
        schema_desc="Scheduled grounds maintenance contracts for estates, managed sites and business premises across Preston and Lancashire.",
    ),
    dict(
        slug="garden-maintenance", cluster="grounds",
        h1="Garden Maintenance in Preston & Lancashire",
        tagline="Regular, reliable garden care for your home",
        price="From £40", price_note="per visit, guide price only",
        meta_title="Garden Maintenance Preston | From £40 | GreenFix",
        meta_description="Garden maintenance in Preston and Lancashire for homeowners. Mowing, edging, weeding and seasonal upkeep, on a one-off or regular basis. From £40.",
        intro="GreenFix keeps residential gardens tidy, healthy and under control across Preston and Lancashire. That covers the everyday jobs that keep a garden looking cared-for between the bigger seasonal work: mowing and edging, weeding beds and borders, light pruning, and general upkeep. Book a one-off visit or set up a regular round — whichever suits how you use your garden.",
        cards=[
        ...
        schema_desc="Regular and one-off garden maintenance for homeowners across Preston and Lancashire, including mowing, edging, weeding and seasonal upkeep.",
    ),
    dict(
        slug="lawn-mowing", cluster="grounds",
        h1="Lawn Mowing in Preston & Lancashire",
        ...
        meta_description="Professional lawn mowing in Preston and Lancashire. Regular cuts or a one-off, with edging included. From £20 per cut.",
        intro="GreenFix cuts lawns across Preston and Lancashire, from a single overdue mow to a regular weekly or fortnightly round through the growing season. Every cut includes edging so borders and paths stay crisp, and we adjust blade height and frequency as the season changes — shorter, more frequent cuts in peak growth, longer intervals when growth slows.",
        cards=[
        ...
        schema_desc="Regular and one-off lawn mowing with edging included, for homes across Preston and Lancashire.",
    ),
    dict(
        slug="hedge-trimming", cluster="grounds",
        h1="Hedge Trimming in Preston & Lancashire",
        tagline="Neat, healthy hedges cut to shape",
        price="From £60", price_note="per visit, guide price only",
        meta_title="Hedge Trimming Preston | From £60 | GreenFix",
        meta_description="Professional hedge trimming in Preston and Lancashire. Shaping, height reduction and waste removal, one-off or seasonal. From £60.",
        intro="GreenFix trims and shapes hedges across Preston and Lancashire, from a routine seasonal cut to bringing an overgrown or misshapen hedge back under control. We cut to a clean, even line, reduce height where needed, and clear all the cuttings away — you're left with a tidy hedge and a tidy garden, not a pile of green waste to deal with yourself.",
        cards=[
        ...
        schema_desc="Hedge trimming, shaping and height reduction with waste removal, for homes across Preston and Lancashire.",
    ),
    dict(
        slug="garden-tidy-ups", cluster="grounds",
        h1="Garden Tidy-Ups in Preston & Lancashire",
        ...
        meta_description="Garden tidy-ups in Preston and Lancashire. A full one-off reset for overgrown gardens — clearing, cutting back and waste removal. From £80.",
        ...
        schema_desc="One-off garden tidy-ups and overgrown garden clearance for homes across Preston and Lancashire.",
    ),
    dict(
        slug="pressure-washing", cluster="grounds",
        h1="Pressure Washing in Preston & Lancashire",
        ...
        meta_description="Professional pressure washing in Preston and Lancashire. Patios, driveways, paths and walls cleaned of moss, algae and grime. From £95.",
        intro="GreenFix pressure washes patios, driveways, paths and exterior walls across Preston and Lancashire, removing built-up moss, algae, grime and staining. This is a cleaning service — restoring the surface you already have to look its best — not a structural repair. If a surface is actually cracked, sunken or damaged rather than just dirty, see our patio repairs, paving repairs or slab relaying pages instead.",
        cards=[
        ...
        schema_desc="Pressure washing for patios, driveways, paths and walls across Preston and Lancashire, removing moss, algae and grime.",
    ),
    dict(
        slug="window-cleaning", cluster="grounds",
        h1="Window Cleaning in Preston & Lancashire",
        ...
        meta_description="Domestic and commercial window cleaning in Preston and Lancashire. Regular rounds or one-off cleans, frames and sills included. Free quote.",
        intro="GreenFix provides window cleaning for homes and businesses across Preston and Lancashire, as a regular round or a one-off clean. Frames and sills are cleaned as standard, not just the glass, so you get a genuinely finished result rather than streak-free panes surrounded by grubby frames.",
        cards=[
        ...
        related=["window-repairs", "pressure-washing", "garden-maintenance"],
        schema_desc="Domestic and commercial window cleaning across Preston and Lancashire, regular rounds or one-off cleans.",
    ),
    # ---------------- Repairs & Maintenance ----------------
    dict(
        slug="exterior-structural-repairs", cluster="repairs",
        h1="Exterior Structural Repairs in Preston & Lancashire",
        ...
        meta_description="Exterior structural repairs in Preston and Lancashire: brickwork, garden walls and masonry. Every job assessed and quoted individually. Call for a survey.",
        ...
        schema_desc="Structural brickwork, masonry and garden wall repair assessment and quotation across Preston and Lancashire.",
    ),
    dict(
        slug="repairs-and-maintenance", cluster="repairs",
        h1="Repairs and Maintenance in Preston & Lancashire",
        ...
        meta_description="General exterior repairs and maintenance in Preston and Lancashire — gutter clearing, bin store upkeep and general property fixes. Call for a quote.",
        ...
        schema_desc="General exterior repairs and maintenance including gutter clearing and bin store upkeep, across Preston and Lancashire.",
    ),
    dict(
        slug="brick-repointing", cluster="repairs",
        h1="Brick Repointing in Preston & Lancashire",
        tagline="Restoring worn or crumbling mortar joints",
        price="From £60 per m²", price_note="guide price only, confirmed after assessment",
        meta_title="Brick Repointing Preston | From £60/m² | GreenFix",
        meta_description="Brick repointing in Preston and Lancashire. Repair eroded or crumbling mortar joints and restore weatherproofing. From £60 per m².",
        ...
        faqs=[
            ...
            ("How is repointing priced?",
             "From £60 per m² as a guide price, confirmed once we've assessed the area and extent of the work needed."),
        ],
        related=["brick-repairs", "garden-wall-repairs", "exterior-structural-repairs"],
        schema_desc="Brick repointing to repair eroded or crumbling mortar joints, priced per square metre, across Preston and Lancashire.",
    ),
    dict(
        slug="brick-repairs", cluster="repairs",
        h1="Brick Repairs in Preston & Lancashire",
        tagline="Repairing damaged, cracked or missing bricks",
        price="From £150 minimum", price_note="guide price only, confirmed after assessment",
        meta_title="Brick Repairs Preston | From £150 | GreenFix",
        meta_description="Brick repairs in Preston and Lancashire — replacing damaged, cracked or spalled bricks. From £150 minimum, guide price.",
        ...
        faqs=[
            ...
            ("Why is there a minimum charge?",
             "Sourcing matching bricks and setting up for a brick repair takes similar time whether it's one brick or several, so a minimum charge applies from £150."),
        ...
        schema_desc="Repair and replacement of damaged, cracked or spalled bricks, matched to existing brickwork, across Preston and Lancashire.",
    ),
    dict(
        slug="garden-wall-repairs", cluster="repairs",
        h1="Garden Wall Repairs in Preston & Lancashire",
        ...
        meta_title="Garden Wall Repairs Preston | From £250 | GreenFix",
        meta_description="Garden wall repairs in Preston and Lancashire. Leaning, cracked or collapsed boundary walls rebuilt and repaired. From £250.",
        ...
        schema_desc="Repair and rebuilding of freestanding garden and boundary walls, including coping stones and piers, across Preston and Lancashire.",
    ),
    dict(
        slug="fence-repairs", cluster="repairs",
        h1="Fence Repairs in Preston & Lancashire",
        ...
        meta_description="Fence repairs in Preston and Lancashire — broken panels, damaged posts and boundary fencing repaired for homes and businesses. From £85.",
        intro="GreenFix repairs fences for homes and businesses across Preston and Lancashire: broken or blown-down panels, rotten or leaning posts, loose boards, and general boundary fence repairs. Fences take the worst of the weather, so a repair now — rather than waiting — usually costs a lot less than replacing the whole run later.",
        cards=[
        ...
        related=["gate-repairs", "garden-wall-repairs", "repairs-and-maintenance"],
        schema_desc="Fence panel, post and boundary fence repairs for homes and businesses across Preston and Lancashire.",
    ),
    dict(
        slug="gate-repairs", cluster="repairs",
        h1="Gate Repairs in Preston & Lancashire",
        ...
        meta_description="Gate repairs in Preston and Lancashire. Sticking, sagging or damaged gates, hinges and latches repaired for homes and businesses. From £65.",
        intro="A gate that sticks, sags, or won't latch properly is usually a hinge, alignment or frame problem rather than something that needs a full replacement. We repair and adjust garden and boundary gates, timber and metal, for homes and businesses across Preston and Lancashire — fixing hinges, latches, and alignment so the gate opens, closes and locks the way it should.",
        cards=[
        ...
        schema_desc="Gate hinge, latch and alignment repairs for homes and businesses across Preston and Lancashire.",
    ),
    dict(
        slug="patio-repairs", cluster="repairs",
        h1="Patio Repairs in Preston & Lancashire",
        ...
        meta_description="Patio repairs in Preston and Lancashire — cracked, sunken or loose slabs fixed. From £95. This is a structural repair, not patio cleaning.",
        ...
        schema_desc="Repair of cracked, sunken or loose patio slabs across Preston and Lancashire, distinct from patio cleaning.",
    ),
    dict(
        slug="paving-repairs", cluster="repairs",
        h1="Paving Repairs in Preston & Lancashire",
        tagline="Driveways and paths repaired, not just cleaned",
        price="From £95", price_note="guide price only, confirmed after assessment",
        meta_title="Paving Repairs Preston | From £95 | GreenFix",
        meta_description="Paving repairs in Preston and Lancashire — cracked block paving, potholes and sunken driveway or path areas fixed. From £95.",
        ...
        schema_desc="Repair of cracked, sunken or poorly edged driveway and path paving across Preston and Lancashire.",
    ),
    dict(
        slug="slab-relaying", cluster="repairs",
        h1="Slab Relaying in Preston & Lancashire",
        tagline="Lifting and relaying uneven or poorly-laid slabs",
        price="From £95", price_note="guide price only, confirmed after assessment",
        meta_title="Slab Relaying Preston | From £95 | GreenFix",
        meta_description="Slab relaying in Preston and Lancashire — uneven or poorly-laid patio and path slabs lifted, re-based and relaid level. From £95.",
        ...
        schema_desc="Lifting and relaying uneven or poorly-drained patio and path slabs across Preston and Lancashire.",
    ),
    dict(
        slug="roof-tile-repairs", cluster="repairs",
        h1="Roof Tile Repairs in Preston & Lancashire",
        tagline="Slipped, cracked or missing tiles refitted",
        price="From £145", price_note="guide price only, confirmed after assessment",
        meta_title="Roof Tile Repairs Preston | From £145 | GreenFix",
        meta_description="Roof tile repairs in Preston and Lancashire. Slipped, cracked or missing roof and ridge tiles refitted or replaced. From £145.",
        ...
        schema_desc="Repair and replacement of slipped, cracked or missing roof and ridge tiles across Preston and Lancashire.",
    ),
    dict(
        slug="drain-repairs", cluster="repairs",
        h1="Drain Repairs in Preston & Lancashire",
        tagline="Blocked, cracked or collapsed drains fixed",
        price="From £95", price_note="guide price only, confirmed after assessment",
        meta_title="Drain Repairs Preston | From £95 | GreenFix",
        meta_description="Drain repairs in Preston and Lancashire — blocked, cracked or collapsed drain runs, downpipes and gullies fixed. From £95.",
        ...
        schema_desc="Repair of blocked, cracked or collapsed individual drains, downpipes and gullies across Preston and Lancashire.",
    ),
    dict(
        slug="drainage-repairs", cluster="repairs",
        h1="Drainage Repairs in Preston & Lancashire",
        tagline="Waterlogged gardens and surface water put right",
        price="From £95", price_note="guide price only, confirmed after assessment",
        meta_title="Drainage Repairs Preston | From £95 | GreenFix",
        meta_description="Drainage repairs in Preston and Lancashire — waterlogged gardens, poor surface water drainage and soakaways fixed. From £95.",
        ...
        schema_desc="Repair of waterlogged gardens, failed soakaways and surface-water drainage across Preston and Lancashire.",
    ),
    dict(
        slug="window-repairs", cluster="repairs",
        h1="Window Repairs in Preston & Lancashire",
        tagline="Frames, seals and hardware repaired — not cleaning",
        price="From £65", price_note="guide price only, confirmed after assessment",
        meta_title="Window Repairs Preston | From £65 | GreenFix",
        meta_description="Window repairs in Preston and Lancashire — damaged frames, failed seals, hinges and handles fixed. From £65. This is repair work, not window cleaning.",
        ...
        schema_desc="Repair of damaged window frames, seals, hinges and handles across Preston and Lancashire.",
    ),
    dict(
        slug="door-repairs", cluster="repairs",
        h1="Door Repairs in Preston & Lancashire",
        tagline="Sticking, damaged or draughty exterior doors fixed",
        price="From £65", price_note="guide price only, confirmed after assessment",
        meta_title="Door Repairs Preston | From £65 | GreenFix",
        meta_description="Exterior door repairs in Preston and Lancashire — sticking doors, damaged frames, hinges and locks fixed. From £65.",
        intro="A sticking, dragging or draughty exterior door is usually a hinge, frame, or alignment problem rather than something needing a full replacement. We repair external doors for homes and businesses across Preston and Lancashire — fixing hinges, locks, damaged frame sections, and worn weatherproofing seals so the door opens, closes and locks properly again.",
        cards=[
        ...
        schema_desc="Repair of sticking, damaged or draughty exterior doors for homes and businesses across Preston and Lancashire.",
    ),
]
...
def local_business_schema():
    data = {
        ...
        "description": (
            ...
            "Lancashire, Wigan and Greater Manchester — covering grounds and "
...
def render_footer():
    ...
    return f"""    <footer>
        ...
        <div class="footer-bottom">
            ...
            <p>{INSURANCE} &middot; {TRAINED} &middot; {WASTE_CARRIER} &middot; Trading since {FOUNDED} &middot; {JOBS_COUNT} completed jobs &middot; Prices shown are guide prices only.</p>
        </div>
    </footer>
"""
    ...
    return f"""    <section class="section-white" style="padding-top:0;">
        <div class="container">
            <div class="trust-strip">
                ...
                <span>✓ <strong>Trading since {FOUNDED}</strong> &middot; {JOBS_COUNT} jobs completed</span>
            </div>
        </div>
    </section>
"""
...
HOMEPAGE_FAQS = [
    ...
    ("What areas do you cover?",
     f"Preston, the whole of {ADDRESS_REGION}, Wigan and Greater Manchester, including Penwortham, Leyland, Chorley, Fulwood and Bamber Bridge."),
    ("Are you insured?",
...
def render_homepage():
    ...
    head = render_head(
        ...
        description="GreenFix Exterior Care: grounds & garden maintenance and exterior property repairs for homes and businesses across Preston, Lancashire, Wigan and Greater Manchester.",
        canonical_path="/",
        extra_schema=schema,
    ...
    body = f"""    <section id="main-content" class="hero">
        <div class="hero-content">
            <picture>
                ...
                <img class="hero-image" src="/hero-commercial-1200w.webp" alt="GreenFix Exterior Care team carrying out grounds maintenance in Preston, Lancashire" width="1200" height="630" loading="eager" fetchpriority="high">
            </picture>
            <h1>Property Maintenance &amp; Construction Repairs Across Preston &amp; Lancashire</h1>
    ...
    <section class="section-white">
        <div class="container">
            ...
            <p class="lede center" style="margin-bottom:1.5rem;">Alongside homeowners, we support these sectors across Preston and Lancashire.</p>
            <div class="grid grid-3">
                {sector_cards}
            </div>
        </div>
    ...
    <section class="section-grey">
        <div class="container">
            ...
            <div class="trust-strip">
                ...
                <span>✓ <strong>{TRAINED}</strong></span>
                <span>✓ <strong>{WASTE_CARRIER}</strong></span>
                <span>✓ <strong>Trading since {FOUNDED}</strong></span>
                <span>✓ <strong>{JOBS_COUNT} completed jobs</strong></span>
            </div>
        </div>
    </section>
...
def render_about():
    ...
    head = render_head(
        ...
        description=f"About {BUSINESS_NAME} — property maintenance and construction repairs for homes and businesses across Preston and Lancashire since {FOUNDED}.",
...
def render_gallery():
    ...
    head = render_head(
        ...
        description="The range of grounds care and exterior repair work GreenFix carries out for homes and businesses across Preston and Lancashire.",
    ...
    <section id="main-content" class="hero">
        <div class="hero-content">
            <h1>Recent Work</h1>
            <p class="tagline">The kind of jobs we handle across Preston &amp; Lancashire</p>
        </div>
    </section>
...
SECTOR_PAGES = [
    dict(
        ...
        h1="Commercial Property Maintenance in Preston & Lancashire",
        ...
        meta_description="Commercial property maintenance in Preston and Lancashire: grounds care, car park upkeep, and exterior repairs for offices, retail units and business premises.",
        intro="GreenFix provides property maintenance for commercial premises across Preston and Lancashire, covering both grounds care (car park borders, communal grounds, general tidiness) and exterior repairs (fencing, paving, brickwork, drainage) that keep a business premises presentable and in good repair.",
        cards=[
    ...
    dict(
        ...
        h1="Factory & Warehouse Grounds Maintenance in Preston & Lancashire",
        ...
        meta_description="Grounds maintenance and exterior repairs for factories and warehouses in Preston and Lancashire — yards, car parks, fencing and drainage.",
    ...
    dict(
        ...
        h1="Care Home Grounds Maintenance in Preston & Lancashire",
        ...
        meta_description="Care home grounds maintenance in Preston and Lancashire — safe garden care, path repairs and grounds upkeep for residents, staff and visitors.",
    ...
    dict(
        ...
        h1="Church Grounds Maintenance in Preston & Lancashire",
        tagline="Churchyard care and respectful exterior upkeep",
        meta_title="Church Grounds Maintenance Preston | GreenFix",
        meta_description="Church grounds maintenance in Preston and Lancashire — churchyard care, path repairs and respectful exterior upkeep around services and events.",
        intro="GreenFix maintains churchyards and church grounds across Preston and Lancashire, working reliably and respectfully around services and events. That covers regular grounds care as well as the masonry and path repairs that older church buildings and boundary walls often need.",
        cards=[
    ...
    dict(
        ...
        h1="Event & Venue Grounds Maintenance in Preston & Lancashire",
        tagline="Visitor-ready grounds before events, tidied after",
        meta_title="Event & Venue Grounds Maintenance Preston | GreenFix",
        meta_description="Event and venue grounds maintenance in Preston and Lancashire — grounds prepared before events, patios and paths pressure washed and repaired.",
    ...
    dict(
        ...
        h1="School & Nursery Grounds Maintenance in Preston & Lancashire",
        ...
        meta_description="School and nursery grounds maintenance in Preston and Lancashire. Playing field care, fence repairs and grounds upkeep scheduled around term time.",
    ...
    dict(
        ...
        h1="Pub & Restaurant Grounds Maintenance in Preston & Lancashire",
        ...
        meta_description="Grounds maintenance and pressure washing for pubs and restaurants in Preston and Lancashire — beer gardens, patios and car parks kept customer-ready.",
    ...
    dict(
        ...
        h1="Shop & Retail Unit Exterior Maintenance in Preston & Lancashire",
        tagline="Presentable shopfronts, car parks and service areas",
        meta_title="Shop & Retail Exterior Maintenance Preston | GreenFix",
        meta_description="Exterior maintenance for shops and retail units in Preston and Lancashire — pressure washing, grounds care and repairs for business parks.",
...
BLOG_POSTS = [
    dict(
        ...
        body=[
            ...
            "A regular round takes the guesswork out of it — the mower turns up on a schedule that suits the season, rather than you trying to judge it yourself. Preston and Lancashire's mild but wet climate means growth can pick up quickly after a rainy spell, which is exactly why a scheduled round tends to suit gardens in this area better than trying to judge it yourself.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "It's worth getting a specific quote rather than assuming a generic guide price applies — a garden that's mostly lawn costs less to maintain than one with several beds, borders and hedges needing attention on every visit. Gardens across Preston, Penwortham, Leyland and the wider Lancashire area vary a lot in size and layout, so a specific quote for your own garden is always more accurate than a generic figure.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "Most contracts can flex with the seasons — more frequent visits during peak growth, less during winter — rather than being a rigid year-round schedule that doesn't match actual growth. This is especially relevant for larger sites and estates across Preston and Lancashire, where consistency across multiple visits matters more than it would for a single household garden.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "If a hedge has been left for a long time and needs significant reduction, it's worth getting it assessed first — the right approach depends on the hedge type and how much it's grown out. Hedges are a common boundary choice across Preston and Lancashire gardens, so getting the timing and technique right matters for a huge number of properties in the area.",
        ],
    ),
    dict(
        slug="garden-completely-overgrown-where-to-start",
        title="My Garden Is Completely Overgrown — Where Do I Start?",
        ...
        body=[
            ...
            "Once a garden's been reset this way, it's usually straightforward to move onto a regular garden maintenance schedule to keep it that way — the hard part is the initial reset, not keeping on top of it afterwards. This is one of the most requested jobs we see across Preston and Lancashire, particularly after a house move or a long period where a garden's been left unattended.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "If a patio or driveway is already cracked, sunken, or has loose slabs rather than just being dirty, pressure washing won't fix that — that's a repair job, not a cleaning one, and pushing a jet washer over damaged paving can make loose sections worse rather than better. Lancashire's damp climate means algae and moss build up on patios and driveways faster here than in drier parts of the country, which is why pressure washing is such a regularly requested job across Preston and the surrounding area.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "A regular round tends to work out easier than one-off cleans booked irregularly, since windows cleaned to a schedule never get bad enough to need extra work to bring them back up to standard. Properties near busier roads in and around Preston, or homes further out into rural Lancashire exposed to more weather, often benefit from a slightly more frequent round than the general guide above.",
        ],
    ),
    dict(
        slug="fence-needs-repairing-or-replacing",
        title="How Do I Know If My Fence Needs Repairing or Replacing?",
        ...
        body=[
            ...
            "If it's not obvious which category a fence falls into, it's worth having it looked at — the cost difference between a repair and a replacement is significant, and it's not always visually obvious from the panels alone whether the posts underneath are still sound. Fencing across Preston and Lancashire takes a battering from regular wind and rain, which is why fence repairs are one of the most common call-outs we see in the area.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "In most cases a gate can be repaired — re-hung, hinges replaced, or the post reset — without needing a full replacement gate, which is usually the more expensive part of the job. This is a common repair across Preston and Lancashire gardens, particularly on older timber gates that have been in place for many years.",
        ],
    ),
    dict(
        ...
        answer="Brick repointing is typically priced per square metre of wall, from around £60 per m² as a guide price, with the final cost depending on how much of the wall needs repointing and how accessible it is.",
        body=[
    ...
    dict(
        ...
        body=[
            ...
            "The fix is straightforward: damaged bricks are removed and replaced with matching bricks, and if the surrounding mortar has also failed, repointing that area at the same time stops water getting back into the new brickwork the same way. This is a common issue on older brick properties across Preston and Lancashire, where many buildings have been standing through decades of freeze-thaw winters.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "In many cases only the affected section needs rebuilding, not the whole wall — but that's a judgement that needs an actual assessment of the wall's condition, not a guess from how it looks from a distance. Garden and boundary walls are a common feature on properties across Preston and Lancashire, particularly older housing stock, which is why we're regularly asked to assess and repair them.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "Repairing a patio properly means addressing the base, not just replacing the visible slab — otherwise the same section is likely to sink again within a season or two. This is one of the most common repair enquiries we get from homeowners across Preston and Lancashire, especially on patios more than a few years old.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "Matching the replacement blocks or tarmac to the existing driveway is usually possible, though an exact colour match depends on how available the original material still is. This is a frequent issue on driveways across Preston and Lancashire, particularly older block paving laid before modern edge-restraint standards became common.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "A common sign it's needed: water pooling on a patio or path well after rain has stopped, rather than draining away within a reasonable time. This is a common job across Preston and Lancashire gardens, especially on patios and paths laid more than five or so years ago.",
        ],
    ),
    dict(
    ...
    dict(
        ...
        body=[
            ...
            "If a drain has blocked more than once at the same location, it's worth having the actual pipe assessed and repaired rather than continuing to clear the same blockage repeatedly — the repeat call-outs usually end up costing more than fixing the underlying pipe issue once. This is one of the most common repeat call-outs we see across Preston and Lancashire, particularly on older properties with mature trees nearby.",
        ],
    ),
    dict(
        ...
        body=[
            ...
            "The right fix depends on identifying the actual cause for that specific spot, rather than guessing — the same symptom (standing water) can have quite different underlying causes from one garden to the next. Heavier clay soil is common across parts of Preston and Lancashire, which is exactly the kind of ground that holds water longer than it should without proper drainage in place.",
        ],
    ),
    dict(
...
def render_blog_post(post):
    ...
    <section class="section-grey">
        <div class="container" style="max-width:760px;text-align:center;">
            ...
            <p class="lede center" style="margin-bottom:1.25rem;">GreenFix provides {esc(service_name.lower())} across Preston and Lancashire. {esc(service["price"])} ({esc(service["price_note"])}).</p>
            <div class="button-group">
...
def build_chatbot_kb():
    ...
    entries.append({
        ...
        "a": f"We cover Preston, the whole of {ADDRESS_REGION}, Wigan and Greater Manchester, including Penwortham, Leyland, Chorley, Fulwood and Bamber Bridge.",
    })
    ...
    entries.append({
        ...
        "a": f"Yes — we hold {INSURANCE} and are a {WASTE_CARRIER}. We're a {TRAINED.lower()}, trading since {FOUNDED} with {JOBS_COUNT} completed jobs.",
    })
